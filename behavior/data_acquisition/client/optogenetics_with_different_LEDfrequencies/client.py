...
# args['LEDfreq'] used to be float, not int (~2021.2.22)
...
class Client(object):
    ...
    def readArguments(self):
        ...
        ap.add_argument("--LEDfreq", type=float)
        ...
        ap.add_argument("--pufffreq", type=float)
