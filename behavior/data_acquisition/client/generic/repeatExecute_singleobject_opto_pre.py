...
#shuffle(schedule)
schedule = [(8,8,0),(8,8,10),(8,8,0),(8,32,0),(8,32,10),(8,32,0)]
print(schedule)
# set color
print('setting color..')
command = 'python setcolorON_opto.py --host ' + str(args['host']) + ' --acclimation 0 -p False --npuff 0 --postPuffInterval 0 --genotype setcolor --width 1 --height 1 --ID 0 --trial 0 --AngularPosBias 0'
os.system(command)
