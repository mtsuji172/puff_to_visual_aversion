...
genotype.set = c('UASTNT.-Tk2G4.','UASTNT.-Tk2G4.Cha7.4G80','UASTNT.VGluTG80-Tk2G4.','UASTNT.-Tk2G4.Gad12AG80')
...
pose_puffeffect$genotype = factor(pose_puffeffect$genotype, levels=c('UASTNT.-Tk2G4.','UASTNT.VGluTG80-Tk2G4.','UASTNT.-Tk2G4.Cha7.4G80','UASTNT.-Tk2G4.Gad12AG80'))
...
stat_pose.interGeno = statPosePuffEffect.interGeno(pose_puffeffect, control='UASTNT.-Tk2G4.', p.adjust.method = 'fdr')
