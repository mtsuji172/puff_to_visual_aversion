...
main_batch(paste0(root, mydir, 'ballrecordings/'))
...
mydf_all.sub = subset(mydf_all, uniq%in%c('UASCsChrimson.-Tk2G4._4_2021.05.08','UASCsChrimson.-Tk2G4.-ATRnega_3_2021.05.30','UASCsChrimson.-DTk1.DTk2Tk2G4._12_2021.05.31'))
...
genotype.set = c('UASCsChrimson.-Tk2G4.-ATRnega','UASCsChrimson.-Tk2G4.','UASCsChrimson.-DTk1.DTk2Tk2G4.')
...
pose_flymean$genotype = factor(pose_flymean$genotype, levels=unique(pose_flymean$genotype))
...
stat_pose.interGeno = statPosePuffEffect.interGeno(pose_puffeffect, control='UASCsChrimson.-Tk2G4.', p.adjust.method = 'fdr')
