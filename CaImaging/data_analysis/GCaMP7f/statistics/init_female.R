...
##################################
outdirs = paste0(path2data, 'jGCaMP7f_152Hz_b-v-b-p-b-p-v-b_female/')
outdir = outdirs
myschedules = list(
...
posinega = read.csv(paste0(outdir, '/export/posinega.csv'))
...
ID.posi = subset(posinega, profile=='posi')$ID %>% unique
